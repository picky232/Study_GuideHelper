export class CreateGoal {
  ...
  async execute({ userId, subject, examType, examFormat, deadline, dailyHours, completedRange, weakPoints }) {
    ...
    return this.goalRepository.create({ userId, subject, examType, examFormat, deadline, dailyHours, completedRange, weakPoints })
  }
}
